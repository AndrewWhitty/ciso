...
########################################################################################################
# Altered original code to do the following:
# 1. Removed argument requirement by looping through all .iso files in the same directory as the script.
# 2. Original file retains the same name but with .cso extension.
# 3. Compression is set at the highest level.
########################################################################################################
...
def main(argv):
    ...
    # loop through all iso files in directory
    for file in os.listdir(directory):
        filename = os.fsdecode(file)
        if filename.endswith(".iso"):
	    # compression ratio set at highest level
            compression_level = 9
            infile = filename
            outfile = infile.replace(".iso", ".cso")
